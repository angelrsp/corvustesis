...
/*
 * Open a store by its name and its location
 */
HCERTSTORE OpenGenericStore(LPCSTR pszCertStoreName)
{
    ...
    if (strcmp("MY", pszCertStoreName) == 0) {
        lpszStoreProvider = CERT_STORE_PROV_SYSTEM;
        dwFlags = dwFlags | CERT_SYSTEM_STORE_CURRENT_USER;
        pvPara =  L"MY";
    } else if (strcmp("ROOT", pszCertStoreName) == 0) {
        lpszStoreProvider = CERT_STORE_PROV_SYSTEM;
        dwFlags = dwFlags | CERT_SYSTEM_STORE_CURRENT_USER;
        pvPara =  L"ROOT";
    } else if (strcmp("CA", pszCertStoreName) == 0) {
        lpszStoreProvider = CERT_STORE_PROV_SYSTEM;
        dwFlags = dwFlags | CERT_SYSTEM_STORE_CURRENT_USER;
        pvPara =  L"CA";
    } else if (strcmp("LocalMachine-MY", pszCertStoreName) == 0) {
        lpszStoreProvider = CERT_STORE_PROV_SYSTEM;
        dwFlags = dwFlags | CERT_SYSTEM_STORE_LOCAL_MACHINE;
        pvPara =  L"MY";
    } else if (strcmp("LocalMachine-ROOT", pszCertStoreName) == 0) {
        lpszStoreProvider = CERT_STORE_PROV_SYSTEM;
        dwFlags = dwFlags | CERT_SYSTEM_STORE_LOCAL_MACHINE;
        pvPara =  L"ROOT";
    } else if (strcmp("LocalMachine-CA", pszCertStoreName) == 0) {
        lpszStoreProvider = CERT_STORE_PROV_SYSTEM;
        dwFlags = dwFlags | CERT_SYSTEM_STORE_LOCAL_MACHINE;
        pvPara =  L"CA";
    } else {
    ...
    return ::CertOpenStore(lpszStoreProvider, 0, NULL, dwFlags, pvPara);
}
...
/*
 * Class:     es_mityc_javasign_pkstore_mscapi_mityc_PRNG
 * Method:    generateSeed
 * Signature: (I[B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_PRNG_generateSeed
...
/*
 * Class:     es_mityc_javasign_pkstore_mscapi_mityc_KeyStore
 * Method:    loadKeysOrCertificateChains
 * Signature: (Ljava/lang/String;Ljava/util/Collection;)V
 */
JNIEXPORT void JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_KeyStore_loadKeysOrCertificateChains
  (JNIEnv *env, jobject obj, jstring jCertStoreName, jobject jCollections)
{
    ...
    __try
    {
        ...
        if ((hCertStore = OpenGenericStore(pszCertStoreName)) == NULL) {
...
/*
 * Class:     es_mityc_javasign_pkstore_mscapi_mityc_Key
 * Method:    cleanUp
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_Key_cleanUp
...
/*
 * Class:     es_mityc_javasign_pkstore_mscapi_mityc_RSASignature
 * Method:    signHash
 * Signature: ([BILjava/lang/String;JJ)[B
 */
JNIEXPORT jbyteArray JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_RSASignature_signHash
 ...
 */
JNIEXPORT jboolean JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_RSASignature_verifySignedHash
  (JNIEnv *env, jclass clazz, jbyteArray jHash, jint jHashSize,
...
/*
 * Class:     es_mityc_javasign_pkstore_mscapi_mityc_RSAKeyPairGenerator
 * Method:    generateRSAKeyPair
 * Signature: (ILjava/lang/String;)Les/mityc/javasign/pkstore/mscapi/mityc/RSAKeyPair;
 */
JNIEXPORT jobject JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_RSAKeyPairGenerator_generateRSAKeyPair
  (JNIEnv *env, jclass clazz, jint keySize, jstring keyContainerName)
{
    ...
    __try
    {
        ...
        jclass clazzRSAKeyPair =
            env->FindClass("es/mityc/javasign/pkstore/mscapi/mityc/RSAKeyPair");
 ...
 */
JNIEXPORT jstring JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_Key_getContainerName
 ...
 * Signature: (J)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_Key_getKeyType
 ...
 */
JNIEXPORT void JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_KeyStore_storeCertificate
 ...
 */
JNIEXPORT void JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_KeyStore_removeCertificate
  (JNIEnv *env, jobject obj, jstring jCertStoreName, jstring jCertAliasName,
 ...
 */
JNIEXPORT void JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_KeyStore_destroyKeyContainer
...
/*
 * Class:     es_mityc_javasign_pkstore_mscapi_mityc_RSACipher
 * Method:    findCertificateUsingAlias
 * Signature: (Ljava/lang/String;Ljava/lang/String;)J
 */
JNIEXPORT jlong JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_RSACipher_findCertificateUsingAlias
  (JNIEnv *env, jobject obj, jstring jCertStoreName, jstring jCertAliasName)
{
    const char* pszCertStoreName = NULL;
    const char* pszCertAliasName = NULL;
 ...
 * Signature: (JZ)J
 */
JNIEXPORT jlong JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_RSACipher_getKeyFromCert
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_KeyStore_getKeyLength
 ...
 * Signature: ([BIJZ)[B
 */
JNIEXPORT jbyteArray JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_RSACipher_encryptDecrypt
...
/*
 * Class:     es_mityc_javasign_pkstore_mscapi_mityc_RSAPublicKey
 * Method:    getPublicKeyBlob
 * Signature: (J)[B
 */
JNIEXPORT jbyteArray JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_RSAPublicKey_getPublicKeyBlob
 ...
 * Signature: ([B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_RSAPublicKey_getExponent
 ...
 * Signature: ([B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_RSAPublicKey_getModulus
    (JNIEnv *env, jclass clazz, jbyteArray jKeyBlob) {
 ...
 */
JNIEXPORT jbyteArray JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_KeyStore_generatePrivateKeyBlob
 ...
 * Signature: (I[B[B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_RSASignature_generatePublicKeyBlob
    (JNIEnv *env, jclass clazz,
        jint jKeyBitLength,
        jbyteArray jModulus,
        jbyteArray jPublicExponent)
 ...
 * Signature: ([BLjava/lang/String;I)Les/mityc/javasign/pkstore/mscapi/mityc/RSAPrivateKey;
 */
JNIEXPORT jobject JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_KeyStore_storePrivateKey
     ...
     jint keySize)
{
    ...
    __try
    {
        ...
        jclass clazzRSAPrivateKey =
            env->FindClass("es/mityc/javasign/pkstore/mscapi/mityc/RSAPrivateKey");
 ...
 * Signature: ([BI)Les/mityc/javasign/pkstore/mscapi/mityc/RSAPublicKey;
 */
JNIEXPORT jobject JNICALL Java_es_mityc_javasign_pkstore_mscapi_mityc_RSASignature_importPublicKey
    (JNIEnv *env, jclass clazz, jbyteArray keyBlob, jint keySize)
{
    ...
    __try
    {
        ...
        jclass clazzRSAPublicKey =
            env->FindClass("es/mityc/javasign/pkstore/mscapi/mityc/RSAPublicKey");
