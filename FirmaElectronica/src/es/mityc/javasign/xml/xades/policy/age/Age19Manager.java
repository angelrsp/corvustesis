...
/**
 * <p>Implementación de la política de la AGE v 1.9 (disponible en 
 * http://administracionelectronica.gob.es/es/ctt/politicafirma).</p>
 * 
 */
public class Age19Manager extends AgeManager {

	/** Logger. */
	private static final Log LOG = LogFactory.getLog(Age19Manager.class);
	/** Internacionalizador. */
	 ...
	 */
	public Age19Manager() throws InstantiationException {
		super();
		if (config == null) {
	 ...
	 * <p>En el caso de AGE 1.9 esto implica versión XAdES distinta a 1.1.1 y XMLDSig</p>
	 * 
	...
	/**
	 * <p>Escribe el nodo de la política de AGE 1.9.</p>
