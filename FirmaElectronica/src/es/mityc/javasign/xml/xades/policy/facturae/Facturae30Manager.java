...
/**
 * <p>Implementación de la política de factura electrónica v 3.0 (disponible en 
 * http://www.facturae.es/politica de firma formato facturae/politica de firma formato facturae v3_0.pdf).</p>
 * 
 */
public class Facturae30Manager extends FacturaeManager {
	/** Logger. */
	private static final Log LOG = LogFactory.getLog(Facturae30Manager.class);
	/** Internacionalizador. */
	private static final II18nManager I18N = I18nFactory.getI18nManager(ConstantsPolicy.LIB_NAME);

	/** Prefijo de las propiedades que afectan al manager que gestiona las políticas de FacturaE v3.0. */
	...
	/**
	 * <p>Valida que se cumpla la policy especificada en el documento:
	 * http://www.facturae.es/politica de firma formato facturae/politica de firma formato facturae v3_0.pdf</p>
	 * 
	 ...
	 *     <li>&lt;xades:SigPolicyId&gt;&lt;xades:Identifier&gt;http://www.facturae.es/politica de firma formato facturae/politica de firma formato facturae v3_0.pdf&lt;/xades:Identifier&gt;&lit;/xades:SigPolicyId&gt;</li>
	...
	public PolicyResult validaPolicy(final Element nodoFirma, final ResultadoValidacion resultadoValidacion) {
		...
		if (LOG.isDebugEnabled()) {
			LOG.debug("Validando política de factura 3.0");
		}
		try {
			...
			// incluye URI de descargar de la política de facturae 3.0
	 ...
	 * <p>En el caso de FacturaE 3.0 esto implica versión XAdES 1.2.2.</p>
	 * 
	...
	/**
	 * <p>Escribe el nodo de la política de facturae 3.0.</p>
