...
import ec.edu.uce.indicadores.commons.util.CalendarUtil;
...
public class CatalogoDAOImpl extends AbstractFacadeImpl<CatalogoDTO> implements CatalogoDAO{
	...
	public List<CatalogoDTO> getAll(CatalogoDTO catalogo)
	{
		...
		{
		Query query = entityManager.createQuery("select cat from CatalogoDTO cat inner join cat.indCatalogo catP where catP.catCodigo=?");
