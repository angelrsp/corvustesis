...
/**
 * The persistent class for the tfi_parametro database table.
 * 
 */
@Entity
@Table(name="tfi_parametro")
@NamedQuery(name="ParametroDTO.findAll", query="SELECT p FROM ParametroDTO p")
public class ParametroDTO implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="TFI_PARAMETRO_PARCODIGO_GENERATOR", sequenceName="TFI_PARAMETRO_PAR_CODIGO_SEQ",allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="TFI_PARAMETRO_PARCODIGO_GENERATOR")
