...
/**
 * The persistent class for the not_alumno_view database table.
 * 
 */
@Entity
@Table(name="not_alumno_view")
@NamedQuery(name="AlumnoViewDTO.findAll", query="SELECT a FROM AlumnoViewDTO a")
public class AlumnoViewDTO implements Serializable {
