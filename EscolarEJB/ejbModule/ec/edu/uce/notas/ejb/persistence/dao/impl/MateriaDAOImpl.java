...
public class MateriaDAOImpl extends AbstractFacadeImpl<MateriaDTO> implements MateriaDAO {
	...
	@Override
	public List<MateriaDTO> getByAnd(MateriaDTO objectDTO) throws CorvustecException
	{
		CriteriaBuilder cb;
        CriteriaQuery<MateriaDTO> cq;
        Root<MateriaDTO> from;
        ...
        Object value;
        Field[] fields;
        TypedQuery<MateriaDTO> typedQuery;
        try{
            cb=entityManager.getCriteriaBuilder();
            cq=cb.createQuery(MateriaDTO.class);
           
            from= cq.from(MateriaDTO.class);
