...
public class PeriodoDAOImpl extends AbstractFacadeImpl<PeriodoDTO> implements PeriodoDAO {
	...
	private static final Logger slf4jLogger = LoggerFactory.getLogger(PeriodoDAOImpl.class);
	...
	@Override
	public List<PeriodoDTO> getByAnd(PeriodoDTO objectDTO) throws CorvustecException
	{
		CriteriaBuilder cb;
        CriteriaQuery<PeriodoDTO> cq;
        Root<PeriodoDTO> from;
        ...
        Object value;
        Field[] fields;
        TypedQuery<PeriodoDTO> typedQuery;
        try{
            cb=entityManager.getCriteriaBuilder();
            cq=cb.createQuery(PeriodoDTO.class);
           
            from= cq.from(PeriodoDTO.class);
