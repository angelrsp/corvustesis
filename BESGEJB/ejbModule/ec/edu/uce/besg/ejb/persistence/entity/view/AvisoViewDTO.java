...
/**
 * The persistent class for the bem_aviso_view database table.
 * 
 */
@Entity
@Table(name="bem_aviso_view")
@NamedQuery(name="AvisoViewDTO.findAll", query="SELECT a FROM AvisoViewDTO a")
public class AvisoViewDTO implements Serializable {
