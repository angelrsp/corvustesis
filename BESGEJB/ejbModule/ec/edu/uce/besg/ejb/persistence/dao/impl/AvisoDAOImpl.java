...
public class AvisoDAOImpl extends AbstractFacadeImpl<AvisoDTO> implements AvisoDAO{
	...
	private static final Logger slf4jLogger = LoggerFactory.getLogger(AvisoDAOImpl.class);
	...
	@Override
	public List<AvisoDTO> getByAnd(AvisoDTO objeto) throws SecurityException
	{
		CriteriaBuilder cb;
		CriteriaQuery<AvisoDTO> cq;
		Root<AvisoDTO> from;
		List<AvisoDTO> list;
		Predicate predicate;
		...
		Object value;
		Field[] fields;
		TypedQuery<AvisoDTO> typedQuery;
		try{
			cb=entityManager.getCriteriaBuilder();
			cq=cb.createQuery(AvisoDTO.class);
			from= cq.from(AvisoDTO.class);
