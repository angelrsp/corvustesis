...
public class EncriptarUtil {
	...
	private final static String claveEncriptar = "claveEncriptar";
	
	private static final EncriptarUtil INSTANCIA = new EncriptarUtil();
	...
	public static EncriptarUtil getFactory(){
