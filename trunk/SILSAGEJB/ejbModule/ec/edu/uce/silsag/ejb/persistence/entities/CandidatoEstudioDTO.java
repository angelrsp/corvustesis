...
/**
 * The persistent class for the vie_candidato_estudio database table.
 * 
 */
@Entity
@Table(name="vie_candidato_estudio")
@NamedQuery(name="CandidatoEstudioDTO.findAll", query="SELECT c FROM CandidatoEstudioDTO c")
public class CandidatoEstudioDTO implements Serializable {
	...
	@Column(name="cat_nivel_estudio")
	private String catNivelEstudio;
	...
	public String getCatNivelEstudio() {
		return this.catNivelEstudio;
	}

	public void setCatNivelEstudio(String catNivelEstudio) {
		this.catNivelEstudio = catNivelEstudio;
	}
