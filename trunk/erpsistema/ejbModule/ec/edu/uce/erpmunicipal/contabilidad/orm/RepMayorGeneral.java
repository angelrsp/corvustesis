...
/**
 * The persistent class for the rep_mayor_general database table.
 * 
 */
@Entity
@Table(name="rep_mayor_general")
public class RepMayorGeneral implements Serializable {
