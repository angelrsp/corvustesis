...
public final class ComprobantesElectronicosWs {
	...
	public static final String SERVICIO_RECEPCION = 
			MessagesApplication.getInstancia().getString("com.corvustec.apce.files.sri.webService.servicio.recepcion");
	
	/**
	 * respuesta recibida webService de recepci&oacute;n del SRI
	 */
	public static final String RESPUESTA_RECIBIDA = 
			MessagesApplication.getInstancia().getString("com.corvustec.apce.files.cliente.webService.respuesta.recibida");
	
	/**
	 * respuesta devuelta webService de recepci&oacute;n del SRI
	 */
	public static final String RESPUESTA_DEVUELTA = 
			MessagesApplication.getInstancia().getString("com.corvustec.apce.files.cliente.webService.respuesta.devuelta");
