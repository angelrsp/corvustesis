...
public final class URIEncoder {
    ...
    /**
     * Devuelve la ruta relativa de un objeto con respecto a una dirección base 
     * 
     * @param base ruta absoluta base
     * @param object ruta absoluta del objeto
     * @return ruta relativa
     */
    public static String relativize(String base, String object) {
    	String res = "";
    	// busca la primera diferencia
    	int i = base.indexOf("/");
    	...
    	// elimina todas las entradas "./" de la cadena relativizada
    	res = res.replace("./", "");
