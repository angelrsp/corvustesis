...
public class CursoDAOImpl extends AbstractFacadeImpl<CursoDTO> implements CursoDAO {
	...
	private static final Logger slf4jLogger = LoggerFactory.getLogger(CursoDAOImpl.class);
	...
	@Override
	public List<CursoDTO> getByAnd(CursoDTO objectDTO) throws CorvustecException
	{
		CriteriaBuilder cb;
        CriteriaQuery<CursoDTO> cq;
        Root<CursoDTO> from;
        List<CursoDTO> list;
        Predicate predicate;
        ...
        Object value;
        Field[] fields;
        TypedQuery<CursoDTO> typedQuery;
        try{
            cb=entityManager.getCriteriaBuilder();
            cq=cb.createQuery(CursoDTO.class);
           
            from= cq.from(CursoDTO.class);
