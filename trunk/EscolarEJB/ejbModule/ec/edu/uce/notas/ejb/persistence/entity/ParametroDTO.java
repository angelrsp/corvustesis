...
public class ParametroDTO implements Serializable {
	...
	@Column(name="par_habilitado")
	private Boolean parHabilitado;
	...
	public Boolean getParHabilitado() {
		return this.parHabilitado;
	}

	public void setParHabilitado(Boolean parHabilitado) {
		this.parHabilitado = parHabilitado;
	}
