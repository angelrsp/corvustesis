...
@NamedQuery(name="PreCertificacion.findAll", query="SELECT p FROM PreCertificacion p")
public class PreCertificacion implements Serializable {
	...
	public PreCertificacionDetalle addPreCertificacionDetalle(PreCertificacionDetalle preCertificacionDetalle) {
		...
		preCertificacionDetalle.setPreCertificacion(this);
	...
	public PreCertificacionDetalle removePreCertificacionDetalle(PreCertificacionDetalle preCertificacionDetalle) {
		...
		preCertificacionDetalle.setPreCertificacion(null);
